...
Intended to work in conjunction with [RekordBoxSongExporter](https://github.com/Unreal-Dan/RekordBoxSongExporter)

This script attempts to sync the playback rate and frame-rate of a video playing in VLC to the master_bpm in Rekordbox.

Check out [BPM to FPS calculator](https://www.silvermansound.com/bpm-to-fps-calculator) for a more detailed explanation of the math used.
...
- Logs to `./logs`, saves last 3 sessions
- Runs 2 threads, file monitor and vlc interface, as daemons
